...
**https://github.com/DJuanes/iot-edge-dynocard/images**

2. Select **main-template.json** from **master** branch as shown in the following figure.
 
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/5.png)

3. Select **Raw** from the top right corner.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/6.png)

4. **Copy** the raw template and **paste** in your azure portal for template deployment.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/7.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/8.png)

4.  The **Edit template** page is displayed as shown in the following figure. 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/9.png)

5.  **Replace / paste** the template and click **Save** button.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/10.png)

6.  The **Custom deployment** page is displayed as shown in the following.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/11.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/12.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/13.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/parameters-basic11.png)
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/parameters12.png)

**Parameters for Standard Solution**

12. If you want to deploy the core with monitoring you must enter the below parameters

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/parameters-standard11.png)
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/parameters12.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/parameters-premium11.png)
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/parameters12.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/17.png)
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/18.png)
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/19.png)
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/20.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/21.png)

2. Click **outputs**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/22.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/23.png)

8. Paste your **main-template.json** in editor as shown below and save the file. 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/24.png) 
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/25.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/26.png)
 
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/27.png)
...
**Ex: az group deployment create --template-file './main-template.json' --parameters '@./main-template.parameters.json' -g oilandgas-iot -n deploy >> outputs.txt**
 ...
 ![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/28.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/29.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/30.png)

2. Copy the Public IP Address of the iotEdge VM.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/31.png)

3. Login to the VM through putty.

4. Paste the public ip at Host Name (or IP address) and click on open.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/32.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/33.png)

7. Here you can check the device and device modules in IoT Edge VM.

**docker ps** 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/moduleslist.png)

8. Go to resource group -> click on **iothub26hs3**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/35.png)

9. Navigate to **IoT Edge** blade under **Automatic Device Management** section.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/iotedge.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/modules-running.png)

### 5.2. Update IoT Hub Device Primary key in Web API Application Settings

1. Go to **Resource Group** -> Click on **iothub26hs3**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/46.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/48.png)

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/49.png)

4. Go to **resource group** -> open the primary web app **webapi26hs3** in the app service.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/50.png)

5. Navigate to **Application settings** blade.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/51.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/52.png)

7. Then click **Save**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/53.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/54.png)

2. **Copy** the **Public IP Address** of the **IoTEdge** VM.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/55.png)

3. Login to the VM through putty.

4. Paste the public IP at Host Name (or IP address) and click on open.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/56.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/57.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/59.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/60.png)

11. Click on **IoT Hub** and navigate to **IoT Edge** blade under **Automatic device management** section.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/61.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/64.png)

15. Click on **Module twin**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/65.png)

16. Change IP Address of slave Connection and click on **Save**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/66.png)

17. In this scenario IP address changed to 104.42.153.165

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/67.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/68.png)

20. Start the Modbus container by passing below command.

**docker start modbus**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/69.png)

21. Now verify slave connection string by checking logs of Modbus.

**docker logs modbus**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/70.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/154.png)

2. Open **Remote desktop connection** and place IP Address and click on **Connect.**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/155.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/156.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/157.png) 

5. Sign out from windows and sign in again.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/158.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/160.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/161.png)

**6.2. Install ML Workbench**
1. Install ML work bench using the setup file from below path.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/162.png) 

2. Double click on **amlWorkbenchSetup.msi** file.
3. Click on **Continue**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/163.png)

4. Click on **Install**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/164.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/165.png)

8. Provide azure portal login credentials. Once login is completed successfully. The below page will be displayed. 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/166.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/167.png)

11. Open edge browser and go to the page **https://microsoft.com/devicelogin** and provide code and click on Continue.
 
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/168.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/169.png)

14. Set current subscription as default using below command.

**az account set -s <enter your sub id here>**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/170.png)

15. Verify default subscription using below command

**az account show**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/171.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/172.png)
 
17. List python packages

**pip freeze**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/173.png)

18. Versions of cli components

**az -v**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/174.png) 

19. All cli cmd for machine learning

**az ml -h**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/175.png) 
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/176.png)

2. Once project is created, refresh home page in GUI, where we can see project name under workspace. 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/177.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/178.png)

3. Extract the zip downloaded project file into ml project sub directory. 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/179.png) 

4. Change directory

**cd C:\mlproject\iot-edge-dynocard-master\code\containers\edge_ml** 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/180.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/181.png)

6. Now go back to GUI. Click on **run history** on left hand pane and it will page as below.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/182.png)

7. Click on **Run** and a page will be opened as below. 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/183.png)

8. Select **model4dc.pkl** and click on **Download.** 

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/184.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/185.png) 

10. Click on **Yes** when it’s prompted for Confirm Save As warning.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/186.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/187.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/188.png)
 
13. Go to GUI and check **Run History** page.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/189.png)

14. Click on **recently completed run job**. A page will be opened as below.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/190.png)

15. Select **Service_schema.json** file and click on **Download**.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/191.png) 
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/192.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/193.png)

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/194.png)

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/195.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/196.png)

19. Set as default using below command.

**az ml env set -g mldevconfigrg -n mldevcofigex**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/197.png)
 
20. Show default environment using below command.

**az ml env show**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/198.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/199.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/200.png)

**az provider register -n Microsoft.ContainerRegistry**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/201.png)

**az provider register -n Microsoft.ContainerService**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/202.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/203.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/204.png)

25. Once process completed, the output will be as below.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/205.png)

26. Go to GUI run history and check recently create Run Number.

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/206.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/207.png)

28. Verify docker container using below command.

**docker ps -a**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/208.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/209.png)

30. Check the logs by running the below command

**Syntax:  az ml service logs realtime –i websvc4dc**

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/210.png)

![alt text](https://github.com/DJuanes/iot-edge-dynocard/images/211.png)
