...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/blob/master/images/oil%26gas-gettingstarted.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/blob/master/images/core.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/blob/master/images/Basic.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/blob/master/images/Standard.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/blob/master/images/Premium.png)
...
![alt text](https://github.com/DJuanes/iot-edge-dynocard/blob/master/images/4.png)
...
https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md

### 4.2. Admin Guide

Refer Admin Guide to perform Administrator tasks of the Solution in Azure Portal.

https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Admin-Guide-Page.md

### 4.3. User Guide

Refer User Guide to find how to use Oil & Gas solution once deployed successfully in Azure portal. 

https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/User-Guide.md
